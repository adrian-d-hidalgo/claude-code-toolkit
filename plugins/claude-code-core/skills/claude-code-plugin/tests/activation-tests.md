# Activation tests — claude-code-plugin
...
python3 scripts/run_activation_evals.py \
  --skill plugins/claude-code-core/skills/claude-code-plugin           # offline shape check
python3 scripts/run_activation_evals.py \
  --skill plugins/claude-code-core/skills/claude-code-plugin --live    # live evaluation
```
