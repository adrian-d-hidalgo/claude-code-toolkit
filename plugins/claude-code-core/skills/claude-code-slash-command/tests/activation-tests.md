# Activation tests — claude-code-slash-command
...
python3 scripts/run_activation_evals.py \
  --skill plugins/claude-code-core/skills/claude-code-slash-command           # offline shape check
python3 scripts/run_activation_evals.py \
  --skill plugins/claude-code-core/skills/claude-code-slash-command --live    # live evaluation
```
